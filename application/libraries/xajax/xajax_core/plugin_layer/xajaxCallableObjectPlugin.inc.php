...
/*
@package xajax
@version $Id: xajaxCallableObjectPlugin.inc.php,v 1.1 2013-02-11 00:49:46 developer Exp $
		...
		if (false === $this->bDeferScriptGeneration || 'deferred' === $this->bDeferScriptGeneration)
		{
			if (0 < count($this->aCallableObjects))
			{
				...
				if ($asHtml) {
					...
					$html .= $this->aCallableObjects[$sKey]->generateClientScript($this->sXajaxPrefix, $asHtml);
