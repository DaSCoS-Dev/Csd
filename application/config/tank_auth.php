...
|--------------------------------------------------------------------------
*/
$config["website_name"] = "{$GLOBALS["_SERVER"]["HTTP_HOST"]}";
$config["webmaster_email"] = "register@{$GLOBALS["_SERVER"]["HTTP_HOST"]}";
$config["newsletter_email"] = "newsletter@{$GLOBALS["_SERVER"]["HTTP_HOST"]}";
$config["support_email"] = "support@{$GLOBALS["_SERVER"]["HTTP_HOST"]}";
$config["generic_email"] = "info@{$GLOBALS["_SERVER"]["HTTP_HOST"]}";
...
*/
if ($config["is_live"] ){
	$config["autologin_cookie_name"] = "autologin_{$GLOBALS["_SERVER"]["HTTP_HOST"]}";
} else {
	$config["autologin_cookie_name"] = "autologin_dev_{$GLOBALS["_SERVER"]["HTTP_HOST"]}";
}
...
|--------------------------------------------------------------------------
*/
$config["captcha_path"] = "application/libraries/tank_auth/captcha/";
$config["captcha_fonts_path"] = "application/libraries/tank_auth/captcha/fonts/4.ttf";
$config["captcha_width"] = 200;
$config["captcha_height"] = 50;
$config["captcha_font_size"] = 22;
$config["captcha_char_number"] = 6;
...
$config["recaptcha_public_key"] = "6LdzidgSAAAAANz8vukcCdN3yMgCAhSgH3L-nlcV";
$config["recaptcha_private_key"] = "6LdzidgSAAAAALbO1Trgxoh76QFCH2fM1-GBrRE4";
