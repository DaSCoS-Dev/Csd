...
Thanks for joining <?php echo $site_name; ?>. We have listed your login details in detail below, please be sure to keep them safe.<br />
To access <?php echo $site_name; ?> please follow this link:<br />
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/auth/login/'); ?>" style="color : #3366cc;">Access <?php echo $site_name; ?> now!</a></b></big><br />
<br />
The link does not work? Copy it into your browser's address bar:<br />
<nobr><a href="<?php echo site_url('/'); ?>" style="color: #3366cc;"><?php echo site_url('/'); ?></a></nobr><br />
<br />
<br />
