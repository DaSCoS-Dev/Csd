	...
	<div class="row row-cols g-1 gap-2">
		...
		<div id="record_form_pieces_{$id}" class="row shadow bg-body rounded">
			...
			<div id="_action_buttons_{$id}" class="w-100">
				<a href="javascript:void(0)" class="btn btn-primary" onclick="xajax_execute('Exampletable/Main_exampletable', 'index', 'edit', {$id})">
					<i class="bi bi-arrow-clockwise">Reload</i>
				</a>
				<a href="javascript:void(0)" class="btn btn-success" onclick="xajax_execute('Exampletable/Main_exampletable', 'index', 'save', xajax.getFormValues( 'tab_record_{$id}', true) )">
