...
<div id="show_records_wrapper" style="display: none" class="col w-100 bg-white text-dark p-2">
	<a href="javascript:void(0)" class="btn btn-primary" onclick="xajax_execute({$library_name_U}/Main_{$library_name_U}', 'index')">
		<i class="bi bi-arrow-clockwise">Reload</i>
	</a>
	<a href="javascript:void(0)" class="btn btn-primary" onclick="xajax_execute('{$library_name_U}/Main_{$library_name_U}', 'index', 'new')">
