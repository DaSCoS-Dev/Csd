...
class CI_Loader {
	...
	public function easy_initialize( ) {
		$this->_ci_classes = array ();
		$this->_ci_loaded_files = array ();
		$this->_ci_models = array ();
		$this->_base_classes = & is_loaded();
	...
	// --------------------------------------------------------------------
	public function model_options( $model, $options = null) {
		return $this->model( $model, "", false, $options );
	}
	 ...
	 * @return void
	 */
	public function model( $model, $name = '', $db_conn = FALSE, $options = null ) {
		if (is_array( $model )) {
			foreach ( $model as $babe ) {
				$this->model( $babe, "", false, $options );
			}
			return;
		}
	 ...
	 * @return void
	 */
	public function view( $view, $vars = array(), $return = FALSE, $_ci_path = false ) {
		$array = array (
				'_ci_view' => $view,
		...
		foreach ( array (
			...
			foreach ( $this->_ci_library_paths as $path ) {
				...
				if (in_array( $filepath, $this->_ci_loaded_files )) {
					 ...
					 * $dbg = ob_get_contents();
					 * ob_end_clean();
					 * log_message('error', $class." class already loaded. Second attempt ignored. {$dbg}\r\n\r\n");
					 */
					return;
				}
